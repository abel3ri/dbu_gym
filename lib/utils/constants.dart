...
class AppData {
  ...
  static const List<Map<String, dynamic>> carouselContent = [
    {
  ...
  static const Map<String, List<Map<String, dynamic>>> pricingContent = {
    "1-3Days": [
      {
  ...
  static const Map<String, Map<String, List<String>>> workoutSessionContent = {
    "monWedFri": {
      "program 1": [
  ...
  static const List<Map<String, String>> muscleGroupCategories = [
    {
      "name": "Abdominals",
  ...
  static const List<Map<String, String>> difficultyCategories = [
    {
      "name": "Beginner",
    },
    {
  ...
  static const List<Map<String, String>> equipmentTypeCategories = [
    {
      "name": "Dumbbell",
  ...
  static const List<Map<String, String>> exerciseTypeCategories = [
    {
      "name": "Olympic Weightlifting",
      "imagePath":
          "assets/images/grid_images/exercise/olympic_weightlifting.png",
    },
    {
      "name": "Plyometrics",
  ...
  static const List<Color> difficultyCategoryColors = [
    Colors.green,
    Colors.yellow,
    Colors.red,
  ];
